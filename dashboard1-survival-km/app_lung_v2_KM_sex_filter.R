#=============================================================
# Program Name : app_lung_v2_km_sex_filter.R
# Description  : Interactive Kaplan-Meier Survival Analysis
#                Dashboard for NCCTG Lung Cancer Trial
#                Features: Sex filter, Age range filter,
#                CI toggle, Risk table, Conditional Log-rank
# Author       : Anbarasu Arumugham
# Date Created : 2026-02-22
# Version      : 2.0
# Input Data   : survival::lung (R built-in dataset)
# Modified     : 
# Change Log   : v1.0 - Basic KM dashboard
#                v2.0 - Added sex filter, conditionalPanel
#=============================================================
